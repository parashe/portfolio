export const project = [
  ...
  },
  {
    ...
    techStack: ["NextJS","Node.JS", "Express", "MongoDB","HTML", "CSS", "tailwind CSS" , "TypeScript","Rest API"],
  },
  {
    id: 2,
    title: "Travel Website",
    image: "/amazing.png",
    desc: "This  website is currently in development. This contains only the user interface and not connected with the backednd. but it is designed using dummy data so that it can be connected and data can be displayed easily from backend.This is Amazing Nepal  website build using React,Typescript and Tailwind CSS. ",
  ...
  },
  {
    ...
    projectLink: "https://www.subediedu.com/",
